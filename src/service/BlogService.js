export const BlogService = {
    ...
    getBlogsMini() {
        return Promise.resolve(this.getBlogsData().slice(0, 5));
    },

    getBlogsSmall() {
        return Promise.resolve(this.getBlogsData().slice(0, 10));
    },

    getBlogs() {
        return Promise.resolve(this.getBlogsData());
    },

    getBlogsWithOrdersSmall() {
